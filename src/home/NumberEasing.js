...
var NumberEasing = React.createClass({
    ...
    getInitialState() {
        var value = parseFloat(this.props.value, 10);
    ...
    updateNumber() {
        ...
        var currentDisplayValue = (value - this.state.previousValue) * progress + this.state.previousValue;
    ...
    render() {
        var {className, useLocaleString, ease, ...other} = this.props;
